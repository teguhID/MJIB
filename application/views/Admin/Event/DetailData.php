...
<?php foreach ($BidayatulHidayah as $data): ?>
    <a href="<?php echo site_url('Admin/BidayatulHidayah')?>" class="btn-lg btn-info"><i class="fas fa-home"></i></a>
    <a href="<?php echo site_url('Admin/BidayatulHidayah')?>" class="btn-lg btn-secondary"><i class="fas fa-globe"></i></a>
    <div class="row justify-content-center" style="margin-bottom:20px; margin-top:50px">
        ...
        <?php } ?>
            ...
            <a class="btn btn-outline-primary" href="<?php echo site_url('Admin/BidayatulHidayahHalamanEditData/' . $data['id'])?>" style="margin:20px">Edit</a>
        </div>
    </div>
