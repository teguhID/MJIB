...
<?php foreach ($RiyadushSholihin as $data): ?>
    <a href="<?php echo site_url('Admin/RiyadushSholihin')?>" class="btn-lg btn-info"><i class="fas fa-home"></i></a>
    <a href="<?php echo site_url('Admin/RiyadushSholihin')?>" class="btn-lg btn-secondary"><i class="fas fa-globe"></i></a>
    <div class="row justify-content-center" style="margin-bottom:20px; margin-top:50px">
        ...
        <?php } else {?>
                <div class="row justify-content-center">                     
                <img src="<?php echo base_url('assets/admin/img/RiyadushSholihin/' . $data['image'])?>" width="630" height="350"><br>
            </div>
        <?php } ?>
            <div class="card-body">
            ...
            <a class="btn btn-outline-primary" href="<?php echo site_url('Admin/RiyadushSholihinHalamanEditData/' . $data['id'])?>" style="margin:20px">Edit</a>
        </div>
    </div>
