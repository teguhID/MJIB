...
<div class="container">
<a href="<?php echo site_url('Admin/BidayatulHidayahHalamanBuatData')?>" class="btn btn-success" style="margin-right: 10px; margin-bottom:-20px"><i class="fas fa-plus-circle" style="margin-right:8px"></i> Tambah Data</a>
  <div class="row justify-content-center">
    <div class="col-10" style="margin-top:3vw">
        ...
        <tbody>
            <?php $no=1; foreach ($bidayatulHidayah as $data) {?>
                <tr> 
                    <th width="10%" class="text-center"><?php echo $no++;?></th>
                    <td width="70%" class="text-center"><a href="<?php echo site_url('Admin/DetailBidayatulHidayah/' . $data['id'])?>" style="color:black; text-decoration:none" onmouseover="this.style.color='green';" onmouseout="this.style.color='black';"><?php echo $data['judul']; ?></a></td>
