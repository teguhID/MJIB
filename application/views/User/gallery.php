...
<head>
	<title>Home Loan a Banking Category Flat Bootstrap Responsive Website Template | Gallery :: w3layouts</title>
...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- //Custom Theme files -->
	<link rel="stylesheet" href="<?php echo base_url('assets/user/')?>css/lightbox.css"><!-- For-gallery-CSS -->
	<!-- online fonts -->
	<!-- titles -->
