            ...
            <li>
                <div class="slider-info bg1">
                    <div class="banner-text container">
                        ...
                        <a class="bt text-capitalize" href="<?php echo site_url('')?>/User/Jadwal" role="button"> read
                            more
...
<section class="details-books py-5">
    <div class="container py-md-4 mt-md-3">
        <h2 class="heading-agileinfo">Our Media<span>Majelis Jalsatul Itsnain Baa'alawy</span></h2>
        <span class="w3-line black"></span>
        <center>
            <br>
                ...
                <div class="stats1">
                    <div class="row stats_inner">
                        <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                            <img src="<?php echo base_url('assets/user/')?>images/logo1.jpg" alt="logo1"
                                class=" img-fluid">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                            <img src="<?php echo base_url('assets/user/')?>images/logo2.jpg" alt="logo1"
                                class=" img-fluid">
                        </div>
                    </div>
                    <div class="row stats_inner top-st">
                        <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                            <img src="<?php echo base_url('assets/user/')?>images/logo3.jpg" alt="logo1"
                                class=" img-fluid">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                            <img src="<?php echo base_url('assets/user/')?>images/logo1.jpg" alt="logo1"
                                ...
                                <div class="carousel-inner">
                                        ...
                                        <div class="row thumbnail adjust1">
                                            <div class="col-md-3 col-sm-3">
                                                <img class="media-object img-fluid"
                                                    src="<?php echo base_url('assets/user/')?>images/ts1.jpg" alt="" />
                                            </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row thumbnail adjust1">
                                            <div class="col-md-3 col-sm-3">
                                                <img class="media-object img-fluid"
                                                    src="<?php echo base_url('assets/user/')?>images/ts2.jpg" alt="" />
                                            </div>
                                            <div class="col-md-9 col-sm-9">
                                                <div class="caption testi-text">
                                                    <h4>Jane Wilson</h4>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row thumbnail adjust1">
                                            <div class="col-md-3 col-sm-3">
                                                <img class="media-object img-fluid"
                                                    src="<?php echo base_url('assets/user/')?>images/ts3.jpg" alt="" />
                                            </div>
                                            <div class="col-md-9 col-sm-9">
                                                <div class="caption testi-text">
                                                    <h4>Jane Wilson</h4>
