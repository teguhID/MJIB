...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords"
        content="Home Loan Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    <script>
    ...
    <header>
            ...
            <div class="container">
                <div class="t-op row">
                    ...
                    <div class="col-sm-6 top-left">
                        <ul>
                            <li><i class="fas fa-phone"></i> +62 822 3020 0031</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <h1>
                    <a class="navbar-brand text-capitalize" href="<?php echo site_url('')?>/User">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex align-items-center">
                            <div class="content">
                                <div class="logo">
                                    <img src="<?php echo base_url('assets/user/')?>images/logo/baalawy-brand2.png"
                                        alt="">
                                </div>
